      ...
      <div className='flex items-center'>
        <div className='flex justify-center flex-shrink-0 rounded-s-xl'>
          <div className='mr-2 text-gray-800 dark:text-gray-200'>
            {role === "login" && <i className='bi bi-envelope-check flex my-auto text-lg'></i>}
            {role === "register" && <i className='bi bi-envelope-plus flex my-auto text-lg'></i>}
            {role === "google" && <i className='bi bi-google flex my-auto text-lg'></i>}
            {role === "kakao" && (
