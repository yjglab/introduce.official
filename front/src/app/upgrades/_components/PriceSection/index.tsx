...
const plans = [
  {
    ...
    auths: ["프로젝트 50회 업로드", "프로젝트 1개당 키워드 토큰 10개", "모두와 끊김없는 실시간 채팅"],
    recommend: false,
  },
  {
    value: "pro",
    ...
    auths: ["프로젝트 무제한 업로드", "프로젝트 1개당 키워드 토큰 100개", "프라이빗 채팅 룸 개설"],
    recommend: true,
  },
  {
    value: "expert",
    ...
    auths: ["신규 기능 1개월 얼리 액세스", "키워드 토큰 무제한 제공", "프로젝트 메인 페이지 최상위 노출"],
    recommend: false,
  },
];
const PriceSection = () => {
